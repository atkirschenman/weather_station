/// @brief taken from https://github.com/roughleaf/ESP-IDF-CPP-Components/tree/main/bme280_common
...
class BME280
{
  ...
  private:
    ...
    uint8_t _temperatureOversamplingValue =
        temperatureOversamplingX1;               // Default to 1X over sampling
  ...
  public:
    ...
    esp_err_t
    SetTemperatureOversampling(const uint8_t tempOversampling); // ctrl_meas bits 7, 6, 5   page 29
